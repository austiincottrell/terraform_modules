...
resource "google_container_cluster" "cluster" {
  ...
  min_master_version = each.value.kubernetes_version != "latest" ? each.value.kubernetes_version : data.google_container_engine_versions.location[each.value.cluster_name].latest_master_version
